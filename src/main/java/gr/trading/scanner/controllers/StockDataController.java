...
public class StockDataController {
    ...
    private ParallelSymbolHandler symbolHandler;
    ...
    public List getSymbols() throws ExecutionException, InterruptedException {
        ...
        List<OhlcPlusBar> bars = symbolHandler.findAndEnhanceOhlcBarsForSymbols(symbols, start.atStartOfDay(), LocalDateTime.now(), Interval.M5);
