...
@Slf4j
public class TwsMessageListener implements EWrapper {

    private Map<Integer, TwsMessageHandler.SyncedBarsList> histDataByReqId;

    public TwsMessageListener(Map<Integer, TwsMessageHandler.SyncedBarsList> histDataByReqId) {
    ...
    public void symbolSamples(int i, ContractDescription[] contractDescriptions) {
        log.info(EWrapperMsgGenerator.symbolSamples(i, contractDescriptions));
    }
